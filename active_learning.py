...
def make_dataloaders(
    ...
    """
    Build datasets and dataloaders using:
    - training transform for labeled set
    - evaluation transform for pool and test set
    """
    train_transform = get_train_transform()
    eval_transform = get_eval_transform()

    train_dataset = CIFARDataset(X_labeled, y_labeled, transform=train_transform)
    pool_dataset = CIFARDataset(X_pool, y_pool, transform=eval_transform)
    test_dataset = CIFARDataset(X_test, y_test, transform=eval_transform)
...
def run_active_learning(
    ...
    """
    Run active learning on CIFAR-10.
